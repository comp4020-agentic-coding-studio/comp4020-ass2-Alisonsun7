...
description:
  Does a product have one true price? An introduction to sticker, reference,
  sale and market price, and to the $249 headphones this semester keeps
  returning to.
week: 1
date: 2026-07-27
teachers:
  - marisol-quaye
tags: ["stage-see", "price"]
buildsOn: []
spec:
...
- a **reference price** — a higher number ("was $329") the sticker is set
  against, whether or not anyone ever actually paid it
- a **sale price** — a temporary number, valid until a date nobody reads
- a **market price** — what the same or a near-identical item sells for
  elsewhere, right now
...
This semester follows one purchase: a pair of over-ear headphones currently
priced at **$249**. Every week adds one more piece of information that changes
...
Week 2 asks a narrower version of the same question — is the bigger pack
actually the better buy — and Week 3 asks what a discount is a discount
*from*. Both are the sticker-price question again, wearing a different coat.
