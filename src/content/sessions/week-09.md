...
A near-identical previous-generation model, barely used, is listed for $140.
It has already depreciated past the steepest part of its curve, has most of
its expected lifetime left, and is not "the same product" — but it may serve
the same need. The $109 gap is only worth paying to avoid if the new
...
Pick one thing you own that could plausibly be repaired, rented, or bought
used instead of new, and estimate — even roughly — what each of those
three alternatives would have cost compared to what you actually paid new.

## In class

Using the item you brought, compute a rough lifecycle cost for the "new"
option you actually chose — purchase price plus any running or repair cost
so far, minus any resale value you could still get — and compare it to your
best estimate for the used or repaired alternative.
